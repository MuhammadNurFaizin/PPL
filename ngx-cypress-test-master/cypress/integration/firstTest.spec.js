...
describe('My first test suite', () => {
    ...
    it('Inline form test', () => {
        cy.get('.form-inline').within(() => {
            cy.get('input[placeholder = "Jane Doe"]').type('Muhammad Nur Faizin').should('have.value', 'Muhammad Nur Faizin')
            cy.get('input[placeholder = "Email"]').type('muhammadnurfaizin611@gmail.com').should('have.value', 'muhammadnurfaizin611@gmail.com')
            cy.get('.custom-checkbox').click()
        })
    })

    it('Using the grid test', () => {
        cy.get('#inputEmail1').type('muhammadnurfaizin611@gmail.com').should('have.value', 'muhammadnurfaizin611@gmail.com')
    ...
    it('Basic form test', () => {
        cy.get('#exampleInputEmail1')
            .type('muhammadnurfaizin611@gmail.com')
            .should('have.value', 'muhammadnurfaizin611@gmail.com')
    ...
    it('Block form test', () => {
        cy.get('#inputFirstName[placeholder = "First Name"]').type('Muhammad Nur').should('have.value', 'Muhammad Nur')
        cy.get('#inputLastName[placeholder = "Last Name"]').type('Faizin').should('have.value', 'Faizin')
        cy.get('#inputEmail[placeholder = "Email"]').type('muhammadnurfaizin611@gmail.com').should('have.value', 'muhammadnurfaizin611@gmail.com')
